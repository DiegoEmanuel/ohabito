...
class HomeController {
  Color frequencyBorderColor(int index, MonthModel month) {
    ...
    if (listDay.isEmpty) {
      ...
      } else if (listDay.where((element) => element.isFinished == true).length == 2) {
        return AppColors.purpleb2;
      } else if (listDay.where((element) => element.isFinished == true).length == 3) {
        return AppColors.purpleb3;
      } else if (listDay.where((element) => element.isFinished == true).length == 4) {
